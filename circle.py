...
async def circle(client: Client, message: Message):
    try:
        ...
        if typ == 'photo':
            ...
            return await message.reply_sticker(sticker=im,
            ...
            video.write_videofile("downloads/result.mp4")
            await message.delete()
            await message.reply_video_note(video_note="downloads/result.mp4",
...
modules_help['circle'] = {
    'round': 'Закруглить фото или видео.'
}
